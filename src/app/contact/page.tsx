  ...
  return (
    <div className="container-page section-tight">
      <div className="cyber-reveal min-h-[60vh] flex flex-col justify-center">
        {/* Header */}
        <p className="section-num"><ScrambleText text={data.ui.collab_brief} /></p>
        ...
        <div className="mt-14 grid gap-6 md:grid-cols-3">
          <TiltCard>
            <a
              ...
              className="cyber-card spotlight-card p-7 group transition-all hover:border-[var(--accent-cyan)] block h-full"
            >
          ...
          <TiltCard>
            <div className="cyber-card spotlight-card p-7 h-full">
