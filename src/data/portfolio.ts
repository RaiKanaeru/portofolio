...
const dictionaries: Record<"en" | "id", Dictionary> = {
  id: {
    ui: {
      ...
      archive_title: "PROYEK IT YANG PERNAH SAYA BANGUN.",
      ...
      contact_title: "MARI BANGUN PROYEK IT BERSAMA.",
    ...
    profile: {
      ...
      nickname: "Raihan",
      role: "IT Programmer & Fresh Graduate Software Engineer",
      school: "SMK Negeri 13 Bandung",
      major: "Rekayasa Perangkat Lunak / RPL",
      status: "Fresh Graduate",
      location: "Bandung, Indonesia",
      email: "raihanariansyah160307@gmail.com",
      tagline: "IT programmer yang membangun sistem praktis dengan pendekatan studi kasus.",
      heroLines: ["IT programmer", "membangun sistem", "yang praktis & siap pakai."],
      summary:
        "Saya Raihan Ariansyah, IT programmer dan fresh graduate RPL. Saya membangun web app, backend API, aplikasi mobile, dan sistem IoT yang praktis — dari autentikasi, CRUD, database, hingga dashboard realtime.",
      organization: {
  ...
  en: {
    ui: {
      ...
      archive_title: "IT PROJECTS I'VE BUILT.",
      ...
      contact_title: "LET'S BUILD IT PROJECTS TOGETHER.",
    ...
    profile: {
      ...
      location: "Bandung, Indonesia",
      email: "raihanariansyah160307@gmail.com",
      tagline: "IT programmer building practical systems with a case-study mindset.",
      heroLines: ["IT programmer", "building practical,", "production-ready systems."],
      summary:
        "I'm Raihan Ariansyah, an IT programmer and RPL fresh graduate. I build practical web apps, backend APIs, mobile apps, and IoT systems — authentication, CRUD, databases, and realtime dashboards.",
      organization: {
        name: "MPK SMK Negeri 13 Bandung",
